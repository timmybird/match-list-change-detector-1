...
class Metrics:
    ...
    def __init__(self, port: int = 8000):
        ...
        self.matches_total = Counter(
            'match_list_change_detector_matches_total',
        ...
        self.errors_total = Counter(
            'match_list_change_detector_errors_total',
        ...
        self.processing_time_seconds = Gauge(
            'match_list_change_detector_processing_time_seconds',
            'Time taken to process match list'
        )
        
        self.last_run_timestamp = Gauge(
            'match_list_change_detector_last_run_timestamp',
